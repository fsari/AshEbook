namespace AshEbook.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Books", "UserCreated_Id", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Books", "Attachment_Id", "dbo.Attachments");
            ...
            DropIndex("dbo.Books", new[] { "UserCreated_Id" });
            DropIndex("dbo.Books", new[] { "Attachment_Id" });
